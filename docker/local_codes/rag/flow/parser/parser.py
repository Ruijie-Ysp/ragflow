...
class Parser(ProcessBase):
    ...
    def _pdf(self, from_upstream: ParserFromUpstream):
        ...
        if conf.get("parse_method") == "deepdoc":
            ...
            vision_model = LLMBundle(self._canvas._tenant_id, LLMType.IMAGE2TEXT, llm_name=conf.get("llm_id"), lang=self._param.setups["pdf"].get("lang"), agent_id=self._canvas.get_agent_id())
    ...
    def _image(self, from_upstream: ParserFromUpstream):
        ...
        if conf["parse_method"] == "ocr":
            ...
            cv_model = LLMBundle(self._canvas.get_tenant_id(), LLMType.IMAGE2TEXT, llm_name=conf["llm_id"],lang=lang, agent_id=self._canvas.get_agent_id())
    ...
    def _audio(self, from_upstream: ParserFromUpstream):
        ...
        with tempfile.NamedTemporaryFile(suffix=ext) as tmpf:
            ...
            seq2txt_mdl = LLMBundle(self._canvas.get_tenant_id(), LLMType.SPEECH2TEXT, lang=lang, agent_id=self._canvas.get_agent_id())
