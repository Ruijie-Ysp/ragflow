...
def detailed_usage_from_response(resp):
    ...
    try:
        # Try Google format: resp["usage"]["input_tokens"], resp["usage"]["output_tokens"]
        if 'usage' in resp:
            if 'input_tokens' in resp['usage']:
                usage["input_tokens"] = resp['usage']['input_tokens']
            if 'output_tokens' in resp['usage']:
    ...
    # If no detailed usage found, return zeros
    return usage
