export default {
  translation: {
    ...
    knowledgeDetails: {
      ...
      testingDescription:
        '¡Último paso! Tras finalizar con éxito, deja el resto al sistema. Ten en cuenta que los cambios realizados aquí no se guardan automáticamente. Si ajustas parámetros predeterminados como el peso o el umbral de similitud, recuerda aplicarlos también en la configuración del asistente de chat o del operador de recuperación.',
      ...
      rerankTip: `Opcional. Si se deja vacío, el sistema utilizará una combinación de similitud por palabras clave ponderada y similitud del coseno de vectores ponderada; si se selecciona un modelo de rerank, una puntuación de rerank ponderada reemplazará la similitud del coseno de vectores ponderada. Ten en cuenta que usar un modelo de rerank incrementará significativamente el tiempo de respuesta. Si deseas usar un modelo de rerank, considera un servicio SaaS; si prefieres un modelo de rerank desplegado localmente, asegúrate de ejecutar el sistema en un entorno con GPU adecuado.`,
      topK: 'Top-K',
    ...
    chat: {
      ...
      variable: 'Variable',
      variableTip: `Usadas junto con las API de gestión de asistentes de chat del sistema, las variables pueden ayudar a desarrollar estrategias de prompt más flexibles. Las variables definidas serán utilizadas por el 'Prompt del sistema' como parte de los prompts para el LLM. {knowledge} es una variable especial reservada que representa partes recuperadas de base(s) de conocimiento especificada(s), y todas las variables deben estar rodeadas por llaves {} en el 'Prompt del sistema'.`,
      add: 'Agregar',
      key: 'Clave',
      optional: 'Opcional',
      operation: 'Operación',
    ...
    setting: {
      ...
      embeddingModelTip:
        'El modelo de incrustación predeterminado para cada nueva base de conocimiento creada. Si no puedes encontrar un modelo en el menú desplegable, comprueba si tu proveedor de modelos admite este modelo.',
      ...
      ttsModel: 'Modelo TTS',
      ttsModelTip: 'El modelo de text-to-speech predeterminado.',
    ...
    fileManager: {
      ...
      uploadDescription:
        'Compatible con cargas únicas o por lotes. Está estrictamente prohibido cargar datos de la empresa u otros archivos prohibidos.',
    ...
    flow: {
      ...
      gitHub: 'GitHub',
      githubDescription:
        'Este componente se usa para buscar repositorios. Top N especifica el número de resultados de búsqueda.',
