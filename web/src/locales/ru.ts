  ...
  translation: {
    ...
    knowledgeDetails: {
      ...
      retrievalTestingDescription:
        'Проведите тест поиска, чтобы проверить, может ли система находить нужный контент для LLM.',
      Parse: 'Обработать',
      dataset: 'Набор данных',
      ...
      parsingStatusTip:
        'Время обработки документа зависит от нескольких факторов. Включение таких функций, как Граф знаний, RAPTOR, Автоизвлечение вопросов или Автоизвлечение ключевых слов, значительно увеличит время обработки. Если индикатор выполнения завис, обратитесь к разделу FAQ.',
      ...
      similarityThresholdTip:
        'Система использует взвешенное сходство ключевых слов в комбинации с косинусным сходством векторов или реранкингом. Этот параметр устанавливает порог сходства между запросом пользователя и фрагментами. Фрагменты с оценкой ниже порога будут исключены из результатов. По умолчанию порог установлен на 0.2.',
      ...
      uploadDescription: 'Поддерживает одиночную или пакетную загрузку.',
      chunk: 'Фрагмент',
      bulk: 'Пакетно',
      cancel: 'Отмена',
      close: 'Закрыть',
      ...
      rerankTip: `Опционально. Если оставить пустым, система будет использовать комбинацию взвешенного сходства ключевых слов и векторного косинусного сходства; если выбрана модель реранкинга, взвешенная оценка реранкинга заменит векторное сходство. Обратите внимание, что использование модели реранкинга может увеличить время отклика.`,
      topK: 'Топ-K',
...
<ul>
  ...
  <li>Авто-ключевые слова требуют значительных ресурсов LLM.</li>
      ...
      graphRagMethodTip: `Легкий: (По умолчанию) Использует оптимизированные промпты для извлечения сущностей и связей (ниже ресурсы).</br>
        Общий: Использует универсальные промпты для извлечения сущностей и связей`,
    ...
    chat: {
      ...
      betaError:
        'Сначала получите API ключ системы на странице системных настроек.',
      searching: 'Поиск...',
      parsing: 'Обработка',
      uploading: 'Загрузка',
  ...
  Контент для обобщения.`,
      ...
      gitHub: 'GitHub',
      gitHubDescription: 'Ищет репозитории.',
