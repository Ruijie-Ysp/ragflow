  ...
  translation: {
    ...
    knowledgeDetails: {
      ...
      retrievalTestingDescription:
        'Conduct a retrieval test to check if the system can recover the intended content for the LLM.',
      Parse: 'Parse',
      dataset: 'Dataset',
      ...
      parsingStatusTip:
        'Document parsing time varies based on several factors. Enabling features like Knowledge Graph, RAPTOR, Auto Question Extraction, or Auto Keyword Extraction will significantly increase processing time. If the progress bar stalls, please consult the FAQs.',
      ...
      uploadDescription: 'Supports single or batch file upload.',
      chunk: 'Chunk',
      bulk: 'Bulk',
      cancel: 'Cancel',
      close: 'Close',
      ...
      rerankTip: `Optional. If left empty, the system will use a combination of weighted keyword similarity and weighted vector cosine similarity; if a rerank model is selected, a weighted reranking score will replace the weighted vector cosine similarity. Please be aware that using a rerank model may significantly increase response time. If you wish to use a rerank model, ensure your environment is properly configured.`,
      topK: 'Top-K',
...
`,
      useRaptor: 'RAPTOR',
      useRaptorTip: 'Enable RAPTOR for multi-hop question-answering tasks.',
      prompt: 'Prompt',
      promptTip:
...
<ul>
  ...
  <li>The auto-keyword feature is dependent on the LLM and consumes a significant number of tokens.</li>
      ...
      graphRagMethodTip: `
      Light: (Default) Use prompts provided by LightRAG to extract entities and relationships. This option consumes fewer tokens, less memory, and fewer computational resources.</br>
    ...
    chat: {
      ...
      betaError:
        'Please acquire a system API key from the System Settings page first.',
      searching: 'Searching...',
      parsing: 'Parsing',
      uploading: 'Uploading',
    ...
    setting: {
      ...
      embeddingModel: 'Embedding model',
      embeddingModelTip:
        'The default embedding model for each newly created knowledge base. If you cannot find an embedding model from the dropdown, please check your model provider supports this model.',
      img2txtModel: 'Img2txt model',
      img2txtModelTip:
        'The default img2txt model for each newly created knowledge base. It describes a picture or video. If you cannot find a model from the dropdown, please check your model provider supports this model.',
      ...
      rerankModel: 'Rerank model',
      rerankModelTip: `The default rerank model for reranking chunks. If you cannot find a model from the dropdown, please check your model provider supports this model.`,
      ttsModel: 'TTS Model',
      ttsModelTip:
        'The default text-to-speech model. If you cannot find a model from the dropdown, please check your model provider supports this model.',
      workspace: 'Workspace',
      upgrade: 'Upgrade',
      addLlmTitle: 'Add LLM',
  ...
  The above is the content you need to summarize.`,
      ...
      gitHub: 'GitHub',
      gitHubDescription:
        'A component that searches for repositories. You can use Top N to specify the number of search results.',
...
[Insert text here]`,
    ...
    corpus: {
      title: 'Corpus',
      description: 'View corpus statistics for all knowledge bases',
      patientDataCorpus: 'Patient Data Corpus',
      documentCorpus: 'Document Knowledge Corpus',
      vectorCorpus: 'Vector Knowledge Corpus',
      knowledgeGraphCorpus: 'Knowledge Graph Corpus',

      // 5 types of medical data
      patients: ' Patients',
      orders: ' Orders',
      records: ' Records',
      exams: ' Exams',
      ...
      byKnowledgeBase: 'By Knowledge Base',
      ...
      databaseConfigDescription:
        'Configure medical database connection information',
      hostRequired: 'Please enter host address',
      portRequired: 'Please enter port',
      usernameRequired: 'Please enter username',
      passwordRequired: 'Please enter password',
      databaseRequired: 'Please select database',
      tableRequired: 'Please select table',
      primaryFieldRequired: 'Please select primary field',

      // 5 types of medical data table configuration
      patientTable: 'Patient Table',
      patientField: 'Patient Primary Field',
      orderTable: 'Order Table',
      orderField: 'Order Primary Field',
      recordTable: 'Record Table',
      recordField: 'Record Primary Field',
      examTable: 'Exam Table',
      examField: 'Exam Primary Field',
      labTable: 'Lab Table',
      labField: 'Lab Primary Field',

      selectPatientTable: 'Select Patient Table',
      selectOrderTable: 'Select Order Table',
      selectRecordTable: 'Select Record Table',
      selectExamTable: 'Select Exam Table',
      selectLabTable: 'Select Lab Table',

      patientTableRequired: 'Please select patient table',
      orderTableRequired: 'Please select order table',
      recordTableRequired: 'Please select record table',
      examTableRequired: 'Please select exam table',
      labTableRequired: 'Please select lab table',

      medicalDataConfig: 'Medical Data Configuration',
      medicalDataConfigDescription:
        'Configure 5 types of medical data tables and statistical fields',
    },
    literature: {
      title: 'Literature Processing',
      upload: 'Upload',
      noData: 'No literature yet, please upload PDF files',
      size: 'Size',
      createTime: 'Created',
      processDuration: 'Duration',
      process: 'Process',
      ...
      notFound: 'Literature not found',
      waitingForProcess: 'Waiting for processing...',
      noContent: 'No content',
      agentProcessing: 'Agent Processing',
      processFirst: 'Please process the literature first',
      selectAgent: 'Select Agent',
      runAgent: 'Run Agent',
      agentResults: 'Results',
      noAgentResults: 'No results yet',
      agentSuccess: 'Success',
      agentFailed: 'Failed',
      unknownAgent: 'Unknown Agent',
      uploadSuccess: 'Upload successful',
      uploadFailed: 'Upload failed',
      processSuccess: 'Process request submitted',
      processFailed: 'Process request failed',
      processStarted: 'Processing started',
      deleteSuccess: 'Delete successful',
      deleteFailed: 'Delete failed',
      runAgentSuccess: 'Agent run request submitted',
      runAgentFailed: 'Agent run failed',
      agentStarted: 'Agent processing started',
      parsedContent: 'Parsed Content',
      pdfLoadError: 'Failed to load PDF',
      deleteResult: 'Delete Result',
      deleteResultConfirm: 'Are you sure to delete this result?',
      deleteResultSuccess: 'Delete successful',
      deleteResultFailed: 'Delete failed',
      export: 'Export',
      exportSuccess: 'Export successful',
      exportFailed: 'Export failed',
      exportTxt: 'Text File',
      exportPdfHint: 'Please select "Save as PDF" in the print dialog',
      // Parse method related
      parseMethod: 'Parse Method',
      selectParseMethod: 'Select Parse Method',
      parseMethodMinerU: 'MinerU - For complex layout PDFs',
      parseMethodDeepDOC: 'DeepDOC - Built-in deep learning parser',
      parseMethodPlainText: 'PlainText - Plain text extraction',
      parseMethodTable: 'Table - Table-optimized parsing',
      // Cancel process related
      cancelProcess: 'Cancel',
      cancelSuccess: 'Process cancelled',
      cancelFailed: 'Cancel failed',
      // Input source related
      inputSource: 'Input Source',
      selectInputSource: 'Select Input Source',
      inputSourceMarkdown: 'Original Markdown',
      agentResultsAsInput: 'Agent Results',
      agentResult: 'Result',
      contentLength: 'Content Length',
      chars: 'chars',
      willSegment: 'Will process in {{count}} segments',
      segmentHint:
        'Content is long, will be processed in segments and results merged automatically',
      selectAgentPlaceholder: 'Select an agent',
      // Advanced options
      advancedOptions: 'Advanced Options',
      segmentSize: 'Segment Size',
      segmentSizeDesc: 'Max {{size}} chars per segment, auto-split if exceeded',
      noSegmentDesc:
        'No segmentation, process all content at once (requires large context model)',
    },
  },
};
