export default {
  translation: {
    ...
    knowledgeDetails: {
      ...
      parsingStatusTip:
        'O tempo de processamento do documento varia conforme vários fatores. Ativar recursos como Knowledge Graph, RAPTOR, Extração Automática de Perguntas ou Extração Automática de Palavras-chave aumentará significativamente o tempo de processamento.',
      processBeginAt: 'Início em',
      processDuration: 'Duração',
      progressMsg: 'Progresso',
      testingDescription:
        'Realize um teste de recuperação para verificar se o sistema pode recuperar o conteúdo pretendido para o LLM. Observe que as alterações feitas aqui não são salvas automaticamente. Se você ajustar as configurações padrão aqui, como o peso de similaridade de palavras-chave, atualize as configurações relacionadas de forma sincronizada nas configurações do assistente de chat ou nas configurações do operador de recuperação.',
      similarityThreshold: 'Limite de similaridade',
      similarityThresholdTip:
        'O sistema emprega uma combinação de similaridade de palavras-chave ponderada e similaridade de cosseno vetorial ponderada, ou uma combinação de similaridade de palavras-chave ponderada e pontuação de reranking ponderada durante a recuperação. Este parâmetro define o limite para similaridades entre a consulta do usuário e os fragmentos. Qualquer fragmento com uma pontuação de similaridade abaixo deste limite será excluído dos resultados. Por padrão, o limite é definido como 0,2. Isso significa que apenas os trechos com uma pontuação de similaridade híbrida de 20 ou mais serão recuperados.',
      ...
      rerankTip:
        'Opcional. Se deixar em branco, o sistema usará uma combinação de similaridade por palavra-chave ponderada e similaridade do cosseno vetorial ponderada; se um modelo de rerank for selecionado, uma pontuação de rerank ponderada substituirá a similaridade do cosseno vetorial ponderada. Observe que usar um modelo de rerank aumentará significativamente o tempo de resposta. Se desejar usar um modelo de rerank, considere um serviço de rerank SaaS; se preferir um modelo de rerank implantado localmente, certifique-se de executar o sistema em um ambiente com GPU adequada.',
      topK: 'Top-K',
      topKTip:
    ...
    knowledgeConfiguration: {
      ...
      useRaptorTip:
        'Ative o RAPTOR para tarefas de perguntas e respostas multi-hop.',
      prompt: 'Prompt',
      promptTip:
    ...
    O conteúdo acima precisa ser resumido.`,
      ...
      pageRankTip: `Você pode atribuir uma pontuação PageRank mais alta a bases de conhecimento específicas durante a recuperação. A pontuação correspondente é adicionada às pontuações de similaridade híbrida dos fragmentos recuperados dessas bases de conhecimento, aumentando sua classificação.`,
      tagName: 'Etiqueta',
    ...
    chat: {
      ...
      variable: 'Variável',
      variableTip: `Usadas em conjunto com as APIs de gerenciamento de assistentes de bate-papo, as variáveis ajudam a desenvolver estratégias de prompt do sistema mais flexíveis. As variáveis definidas serão usadas pelo 'Prompt do sistema' como parte dos prompts para o LLM. {knowledge} é uma variável especial reservada que representa partes recuperadas de base(s) de conhecimento especificada(s); todas as variáveis devem ser cercadas por chaves {} no 'Prompt do sistema'.`,
      add: 'Adicionar',
      key: 'Chave',
      optional: 'Opcional',
      operation: 'Operação',
      ...
      betaError:
        'Por favor, adquira uma chave API do sistema na página Configurações do Sistema primeiro.',
    ...
    setting: {
      ...
      embeddingModel: 'Modelo de incorporação',
      embeddingModelTip:
        'O modelo de incorporação padrão para cada nova base de conhecimento criada.',
      img2txtModel: 'Modelo Img2Txt',
      img2txtModelTip:
        'O modelo padrão img2txt para cada base de conhecimento recém-criada. Ele descreve uma imagem ou vídeo.',
      ...
      rerankModelTip: 'O modelo de rerank padrão para reranking de trechos.',
      ttsModel: 'Modelo TTS',
      ttsModelTip: 'O modelo padrão de text-to-speech.',
    ...
    fileManager: {
      ...
      uploadTitle:
        'Clique ou arraste o arquivo para esta área para fazer o upload',
      uploadDescription:
        'Suporta upload individual ou em lote. É estritamente proibido enviar dados corporativos ou outros arquivos proibidos.',
      local: 'Uploads locais',
      s3: 'Uploads S3',
      preview: 'Pré-visualização',
      fileError: 'Erro no arquivo',
      uploadLimit:
        'O sistema suporta o upload de arquivos de forma individual ou em lote. Em implantações locais: o limite total de tamanho de arquivo por upload é de 1GB, com um limite de upload em lote de 32 arquivos. Não há limite para o número total de arquivos por conta.',
    ...
    flow: {
      ...
      gitHub: 'GitHub',
      gitHubDescription:
        'Um componente que realiza buscas por repositórios. Você pode usar Top N para especificar o número de resultados de pesquisa.',
