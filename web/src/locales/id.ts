export default {
  translation: {
    ...
    knowledgeDetails: {
      ...
      testingDescription:
        'Lakukan tes pengambilan untuk memeriksa apakah sistem dapat memulihkan konten yang diinginkan untuk LLM. ',
      ...
      rerankTip: `Opsional. Jika dikosongkan, sistem akan menggunakan kombinasi kemiripan kata kunci berbobot dan kemiripan kosinus vektor berbobot; jika model rerank dipilih, skor rerank berbobot akan menggantikan kemiripan kosinus vektor berbobot. Harap diperhatikan bahwa menggunakan model rerank akan secara signifikan meningkatkan waktu respons. Jika Anda ingin menggunakan model rerank, pertimbangkan layanan rerank SaaS; jika Anda lebih memilih model rerank yang berjalan secara lokal, pastikan sistem berjalan di lingkungan GPU yang sesuai.`,
      topK: 'Top-K',
    ...
    Perhatikan jenis entitas yang perlu Anda tentukan.</p>`,
      ...
      useRaptorTip: 'Aktifkan RAPTOR untuk tugas tanya jawab multi-langkah.',
      prompt: 'Prompt',
      promptTip:
    ...
    chat: {
      ...
      variable: 'Variabel',
      variableTip: `Digunakan bersama dengan API manajemen asisten obrolan, variabel dapat membantu mengembangkan strategi prompt sistem yang lebih fleksibel. Variabel yang didefinisikan akan digunakan oleh 'Prompt Sistem' sebagai bagian dari prompt untuk LLM. {knowledge} adalah variabel khusus yang dicadangkan, mewakili bagian-bagian yang diperoleh dari basis pengetahuan yang ditentukan, dan semua variabel harus dikelilingi oleh kurung kurawal {} dalam 'Prompt Sistem'.`,
      add: 'Tambah',
      key: 'Kunci',
      optional: 'Opsional',
      operation: 'Operasi',
    ...
    setting: {
      ...
      sequence2txtModelTip:
        'Model ASR default yang akan digunakan semua basis pengetahuan baru yang dibuat. Gunakan model ini untuk menerjemahkan suara ke teks yang sesuai. Jika Anda tidak dapat menemukan model dari menu dropdown, silakan periksa konfigurasi penyedia model Anda.',
      rerankModel: 'Model Rerank',
      rerankModelTip: `Model rerank default untuk reranking potongan teks. Jika Anda tidak dapat menemukan model dari dropdown, silakan periksa konfigurasi penyedia model Anda.`,
      ttsModel: 'Model TTS',
      ttsModelTip:
        'Model text-to-speech default. Jika Anda tidak dapat menemukan model dari dropdown, silakan periksa konfigurasi penyedia model Anda.',
    ...
    flow: {
      ...
      gitHub: 'GitHub',
      githubDescription:
        'Komponen ini digunakan untuk mencari repositori. Top N menentukan jumlah hasil pencarian.',
